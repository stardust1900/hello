...
//System.out.println("End Time"+simpleDateFormat.format(date));
	...
	public static class CDRBeanForIndex {
		...
		public long[] start_time_s;//�?始时间，

		public long[] end_time_s;//结束时间

		public String opc_dpc;//�?向设�?
		...
		public int tableType=0;//表类�?

//		public int OnceCount;//要查的记录数

//		public int BeginNum;//从哪条记录数�?始查
		...
		public JSONArray pairElemList;//�?向设�?
...
//	    	System.out.println("�?向设置数�?:"+cdr.getOpc_dpc());
